...
SCAM: dict[str, dict[str, list[str]]] = {
    ...
    "loan_rescue_fraud": {
        "ru": [
            "Это сотрудник Национального банка. На ваше имя оформлен онлайн-кредит. Чтобы отменить его, возьмите новый кредит и переведите деньги на безопасный счет.",
            "Звонит Нацбанк. Нужно подтвердить, что вы не причастны к заявке на кредит. Переведите средства на счет безопасности, иначе кредит останется на вас.",
        ],
        "kz": [
            "Бұл Ұлттық банктің қызметкері. Атыңызға онлайн несие рәсімделді. Оны жою үшін жаңа несие алып, ақшаны қауіпсіз шотқа аударыңыз.",
            "Ұлттық банк хабарласып тұр. Несие өтініміне қатысыңыз жоқ екенін растау керек. Қаражатты қауіпсіз шотқа аударыңыз.",
        ],
    },
    "fake_telecom_support": {
        "ru": [
            "Это поддержка Казахтелекома. Срок договора заканчивается сегодня, интернет отключат. Скачайте файл для подтверждения скидки и установите APK.",
            "Оператор связи предлагает скидку. Откройте ссылку и установите приложение, иначе договор будет закрыт и интернет отключат.",
        ],
        "kz": [
            "Бұл Қазақтелеком қолдауы. Шарт мерзімі бүгін аяқталады, интернет өшеді. Жеңілдікті растау үшін файлды жүктеп, APK орнатыңыз.",
            "Байланыс операторы жеңілдік ұсынып тұр. Сілтемені ашып, қосымша орнатыңыз, әйтпесе шарт жабылады.",
        ],
    },
    "dropper_recruitment": {
        "ru": [
            "Есть легкий заработок для студентов: сдайте банковскую карту в аренду, передайте доступ к онлайн-банкингу и получите оплату за каждую операцию. Куратор в Telegram.",
            "Нужны карты для вывода средств. Передайте доступ к интернет-банкингу, мы будем обналичивать деньги и менять их на криптовалюту.",
        ],
        "kz": [
            "Студенттерге оңай ақша: банк картасын жалға беріңіз, онлайн банкингке кіру деректерін беріңіз, әр операция үшін төлем алыңыз. Куратор Telegram-да.",
            "Қаражатты шығару үшін карталар керек. Банкке кіру деректерін беріңіз, ақшаны қолма-қол шығарып, криптовалютаға айырбастаймыз.",
        ],
    },
}
