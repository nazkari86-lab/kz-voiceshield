...
export const qualityLabManifest: QualityLabAsset[] = [
  ...
  { id: 'silero-vad', title: 'Silero VAD ONNX', role: 'Offline speech-presence and audio-quality candidate', status: 'blocked', source: 'MIT candidate', detail: 'Blocked until an exact artifact checksum, licence verification and Xiaomi benchmark are recorded.' },
