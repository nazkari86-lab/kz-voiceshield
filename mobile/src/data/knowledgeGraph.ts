...
const featureCatalog: KnowledgeNode[] = [
  ...
  { id: 'feature:apk-inspection', type: 'feature', title: 'APK safety inspection', summary: 'Локально читает имя пакета, версию, SHA-256 и заявленные permissions выбранного APK. Не устанавливает, не открывает и не загружает файл. Проверка permissions не является verdict о malware.', tags: ['apk', 'sha256', 'permissions', 'local'], status: 'active' },
...
export function buildKnowledgeGraph(storage: ModelStorageInfo | null = null, runtime: KnowledgeRuntime = {}): KnowledgeGraph {
  ...
  const edges: KnowledgeEdge[] = ([
    ...
    ['app:voiceshield', 'release:v2.0.8', 'current patch release'], ['release:v2.0.8', 'release:v2.0.7', 'succeeds'], ['release:v2.0.7', 'release:v2.0.6', 'succeeds'], ['release:v2.0.6', 'release:v2.0.5', 'succeeds'], ['release:v2.0.5', 'release:v2.0.4', 'succeeds'], ['release:v2.0.4', 'release:v2.0.3', 'succeeds'], ['release:v2.0.3', 'release:v2.0.2', 'succeeds'], ['release:v2.0.2', 'release:v2.0.0', 'succeeds'],
