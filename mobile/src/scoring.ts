...
export const samples = {
  ...
  cryptoWithdrawal:
    'Это поддержка биржи. Зафиксирована подозрительная операция. Для защиты средств срочно переведите крипту на безопасный счет. Назовите код подтверждения и пароль. Через 15 минут доступ заблокируют. Никому не говорите.',
  taxService:
    'Звонит сотрудник налоговой службы. Вы оставляли заявку на перерасчет — ваша анкета рассмотрена. Зафиксировано уголовное дело на ваше имя. Назовите ИИН и код из SMS для сверки. Оплатите по ссылке в течение 24 часов.',
  fakePolice:
    'Это дежурная часть полиция. Ваш родственник попал в беду, задержали его. Никому не говорите и не кладите трубку. Для освобождения до суда срочно переведите деньги на безопасный счет который я назову. Уголовная ответственность иначе.',
}
...
export const sampleMeta = [
  ...
  ['cryptoWithdrawal', 'Crypto seed theft'],
  ['taxService', 'Tax service fraud'],
  ['fakePolice', 'Fake police arrest'],
  ['safe', 'Safe call'],
] as const
...
export const threatRules: ThreatRule[] = [
  ...
  {
    id: 'smishing-bridge',
    title: 'SMS-to-voice multi-channel phishing bridge',
    tactic: 'Multi-channel phishing',
    stage: 'Hook',
    severity: 'high',
    weight: 26,
    minHits: 2,
    terms: [
      ...
      'подтвердите смс которое пришло',
      'открой смс и нажми',
      'смс придет сейчас',
      'найдите смс от нас',
      'в смс будет код',
      'продиктуйте код из смс который мы отправили',
      'смс жібердік',
      'смс келеді',
      'хабарламадағы сілтемені басыңыз',
    ],
    advice: 'SMS + call in tandem is a classic multi-channel attack. Never open SMS links while on an unsolicited call.',
  },
  {
    id: 'caller-id-spoof',
    title: 'Caller ID spoofing trust confirmation',
    tactic: 'Trust engineering',
    stage: 'Hook',
    severity: 'high',
    weight: 22,
    minHits: 1,
    terms: [
      ...
      'номер совпадает с сайтом',
      'звоним с официального номера банка',
    ...
    advice: 'Caller ID spoofing is trivial. The number on your screen does not prove the caller\'s identity — hang up and call back on the official number you type in yourself.',
  },
  {
    id: 'pretexting',
    title: 'Pre-established false context or backstory',
    tactic: 'Pretexting',
    stage: 'Hook',
    severity: 'medium',
    weight: 20,
    ...
    terms: [
      ...
      'по вашей жалобе',
      'по вашему обращению',
      'вы сами заполняли форму',
      'вы регистрировались у нас',
      'ваша анкета рассмотрена',
      'вы участвовали в акции',
      'вы выиграли',
      'ваше имя в списке получателей',
      'сіздің өтінішіңіз бойынша',
      'өтінім берген едіңіз',
      'сіз тізімде бар',
      'сіз жеңдіңіз',
    ],
