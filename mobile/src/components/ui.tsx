...
export function Card({ children, tone }: { children: React.ReactNode; tone?: Severity }) {
  return <View style={[ui.card, tone ? { borderLeftColor: riskColor[tone], borderLeftWidth: 5 } : null]}>{children}</View>
}
...
export const ui = StyleSheet.create({
  ...
  metric: { backgroundColor: colors.chipBg, borderRadius: 12, flexBasis: '31%', flexGrow: 1, gap: 2, padding: 10 },
