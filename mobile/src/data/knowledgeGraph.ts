...
export function buildKnowledgeGraph(storage: ModelStorageInfo | null = null, runtime: KnowledgeRuntime = {}): KnowledgeGraph {
  ...
  const edges: KnowledgeEdge[] = ([
    ...
    ['app:voiceshield', 'release:v2.0.7', 'current patch release'], ['release:v2.0.7', 'release:v2.0.6', 'succeeds'], ['release:v2.0.6', 'release:v2.0.5', 'succeeds'], ['release:v2.0.5', 'release:v2.0.4', 'succeeds'], ['release:v2.0.4', 'release:v2.0.3', 'succeeds'], ['release:v2.0.3', 'release:v2.0.2', 'succeeds'], ['release:v2.0.2', 'release:v2.0.0', 'succeeds'],
