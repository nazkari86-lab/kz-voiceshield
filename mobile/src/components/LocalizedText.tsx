...
const translations: Record<string, { ru: string; kz: string }> = {
  ...
  Mine: { ru: 'Мои', kz: 'Менікі' },
  Unassigned: { ru: 'Не назначены', kz: 'Тағайындалмаған' },
  'All statuses': { ru: 'Все статусы', kz: 'Барлық мәртебе' },
  New: { ru: 'Новое', kz: 'Жаңа' },
  Reviewing: { ru: 'На проверке', kz: 'Тексерілуде' },
  Escalated: { ru: 'Эскалировано', kz: 'Эскалацияланған' },
  Closed: { ru: 'Закрыто', kz: 'Жабық' },
  'Latest decision: ': { ru: 'Последнее решение: ', kz: 'Соңғы шешім: ' },
